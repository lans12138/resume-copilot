...
* ``POST /applications/{id}/runs`` — claim the active slot and enqueue the flow;
...
Creation and approval decisions commit their business facts before
``job_applications.wiring`` publishes the corresponding worker slice.
"""
