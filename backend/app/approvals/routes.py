...
transactional ApplicationRun wiring as the run endpoints. A decision and its
business mutation commit atomically; graph resume is published only afterwards.
"""
